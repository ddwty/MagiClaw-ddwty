...
//static double calculateGripperDistance(std::vector<std::vector<cv::Point2f> > &corners) {
//    // 计算第一个标记的中心点坐标
//    double center1X = (corners[0][0][0][0] + corners[0][0][1][0] + corners[0][0][2][0] + corners[0][0][3][0]) / 4.0;
//    double center1Y = (corners[0][0][0][1] + corners[0][0][1][1] + corners[0][0][2][1] + corners[0][0][3][1]) / 4.0;
//
//    // 计算第二个标记的中心点坐标
//    double center2X = (corners[1][0][0][0] + corners[1][0][1][0] + corners[1][0][2][0] + corners[1][0][3][0]) / 4.0;
//    double center2Y = (corners[1][0][0][1] + corners[1][0][1][1] + corners[1][0][2][1] + corners[1][0][3][1]) / 4.0;
//
//    // 计算两点间的距离
